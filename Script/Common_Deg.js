...
function fillfElectiveAuto(ctlCollegeVal, ctlStreamVal) {
    if (document.getElementById('rbtHonours').checked) {
        ...
        $.ajax({
            type: 'POST',
            url: 'PersonalInfo_Deg.aspx/FillElectives',
...
function fillDist(ctlDdlVal) {
    ...
    $.ajax({
        type: 'POST',
        url: 'PersonalInfo_Deg.aspx/fillDistrict',
...
function fillBlock(ctlDdlVal) {
    ...
    $.ajax({
        type: 'POST',
        url: 'PersonalInfo_Deg.aspx/fillBlock',
...
function CheckDuplicateEmail() {
    ...
    $.ajax({
        type: 'POST',
        url: 'PersonalInfo_Deg.aspx/ChkEmailStatus',
        data: "{'vchEmail':'" + Email + "'}",
        contentType: "application/json; charset=utf-8",
        dataType: 'json',
        success: function (response) {
...
function CheckMobNo() {
    ...
    $.ajax({
        type: 'POST',
        url: 'PersonalInfo_Deg.aspx/ChkMobStatus',
        data: "{'vchMobNo':'" + MobNo + "'}",
        contentType: "application/json; charset=utf-8",
        dataType: 'json',
        success: function (response) {
...
function CHSEMark() {
    ...
    if (document.getElementById('rbtnAnnual').checked == true && parseInt(inVal) == 35 && (yr >= 2013) && roll != '') {
        $.ajax({
            type: 'POST',
            url: 'PersonalInfo_Deg.aspx/fillCHSEMark',
            ...
            success: function (response) {
                ...
                $.each(response, function (index, value) {
                    ...
                    SCHOOL1 = value[0].SCHOOL == '' ? " " : value[0].MNAME;
                    DISTRICT1 = value[0].DISTRICT == '' ? " " : value[0].MNAME;
                    MIL1 = value[0].MIL;
...
//            });
            ...
            if ((document.getElementById('rbtCommerce').checked == true) || (document.getElementById('rbtArts').checked == true) || (document.getElementById('rbtUpashastri').checked == true)) {
                if ((streams == '2')) {
...
function showHideChemistry() {
    ...
    else if ((document.getElementById('rbtArts').checked == true) || (document.getElementById('rbtCommerce').checked == true) || (document.getElementById('rbtUpashastri').checked == true) || (document.getElementById('rbtnMaulvi').checked == true)) {
        $('#tdChemistryH').hide();
        $('#tdChemistryB').hide();
        $('#tdMathH').hide();
        $('#tdMathB').hide();
...
function BoardMarkCheck() {
    ...
    if (parseInt(Math) >= parseInt(Tot)) {
        alert('MIL Mark cannot be greater than or equal to Total Mark');
        $("#txtMath").focus();
        return false;
    }
    if (parseInt(Math) >= parseInt(Max)) {
        alert('MIL Mark cannot be greater than or equal to Maximum Mark');
        $("#txtMath").focus();
        return false;
    }
...
function updateRow(ctlId) {
    ...
    if (!DropDownValidation('ddlGender', 'your gender'))
        return false;
    if ((document.getElementById('rbtArts').checked == false) && (document.getElementById('rbtCommerce').checked == false) && (document.getElementById('rbtScience').checked == false) && (document.getElementById('rbtVocational').checked == false) && (document.getElementById('rbtDiploma').checked == false) && (document.getElementById('rbtUpashastri').checked == false)) {
        alert('Please check stream in +2 Council Exam');
        return false;
    }
    if (!DropDownValidation('ddlCollegeDistrict', 'District Name'))
        return false;
    ...
    if (!blankFieldValidation('txtMath', 'MIL Mark'))
        return false;
...
function ValidateForm() {
    ...
    //========================Sream Validation==================
    if ((document.getElementById('rbtArts').checked == false) && (document.getElementById('rbtScience').checked == false) && (document.getElementById('rbtCommerce').checked == false) && (document.getElementById('rbtVocational').checked == false) && (document.getElementById('rbtDiploma').checked == false) && (document.getElementById('rbtUpashastri').checked == false)) {
...
function CheckSpeCharacterName(Object, msg) {//For Name input in CAF(Restrict Special character except ')
    ...
    for (k = 0; k < Arr.length; k++) {
        ...
        for (var i = 0; i < str1.length; i++) {
            ...
            var ch = str1.substring(i, i + 1);
            if ((ch == "`") || (ch == ">") || (ch == "<") || (ch == "!") || (ch == "^") || (ch == "%") || (ch == "?") || (ch == "~") || (ch == "!") || (ch == "@") || (ch == "#") || (ch == "$") || (ch == "&") || (ch == "*") || (ch == "(") || (ch == ")") || (ch == "_") || (ch == "-") || (ch == "+") || (ch == "/") || (ch == "|") || (ch == "[") || (ch == "]") || (ch == "{") || ch == "}" || (ch == ":") || (ch == ";") || (ch == ",") || (ch == ".") || (ch == '=') || (ch == '"') || (ch == '-')) {
                alert(msg);
                document.getElementById(Arr[k]).value = '';
                document.getElementById(Arr[k]).focus();
                return false;
...
function checkBoardRoll(Object, msg) {
    ...
    for (k = 0; k < Arr.length; k++) {
        ...
        for (var i = 0; i < str1.length; i++) {
            var ch = str1.substring(i, i + 1);
            if ((ch == "`") || (ch == "'") || (ch == ">") || (ch == "<") || (ch == "!") || (ch == "^") || (ch == "%") || (ch == "?") || (ch == "~") || (ch == "!") || (ch == "@") || (ch == "#") || (ch == "$") || (ch == "&") || (ch == "*") || (ch == "(") || (ch == ")") || (ch == "_") || (ch == "+") || (ch == "|") || (ch == "[") || (ch == "]") || (ch == "{") || ch == "}" || (ch == ":") || (ch == ";") || (ch == ",") || (ch == ".") || (ch == '=') || (ch == '"')) {
                alert(msg);
                document.getElementById(Arr[k]).value = '';
                document.getElementById(Arr[k]).focus();
                return false;
