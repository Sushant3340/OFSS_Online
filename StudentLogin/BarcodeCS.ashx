<%@ WebHandler Language="VB" Class="BarcodeCS" %>

Imports System.Drawing
Imports System.Drawing.Imaging

Public Class BarcodeCS : Implements IHttpHandler
    
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        'context.Response.ContentType = "text/plain"
        'context.Response.Write("Hello World")
        Dim Input As String = UCase(context.Request.QueryString("ID").ToString())
        ...
        For i = 1 To Input.Length
            If InStr(1, ValidInput, Mid(Input, i, 1)) = 0 Then
                context.Response.Write("Invalid input")
