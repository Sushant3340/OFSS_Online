<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentLogin_Deg.aspx.cs"
    Inherits="StudentLogin_StudentLogin_Deg" %>
                    ...
                    <div class="col-md-12">
                        <div class="inner-content">
                            ...
                            <div class="loginbody-right">
                                ...
                                <center>
                                    <h3>INTERMEDIATE STUDENT'S LOGIN <span style="color: #d15b47; padding-left: 10px;"><i class="fa fa-user"
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtSMobileNo" MaxLength="10" runat="server" class="form-control"
                                                placeholder="Mobile Number" oncopy="return false" onpaste="return false" oncut="return false"
                            ...
                            <asp:Label ID="lblCaptcha" runat="server" ondragstart="return false" draggable="false"></asp:Label></div>--%>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12 stdnt-btn">
                                        <asp:Button ID="btnSIGNIN" runat="server" Text="Submit" class="btn btn-danger btn-block"
                                            OnClientClick="return Validation()" OnClick="btnSIGNIN_Click" Style="font-size: 18px; font-weight: bold;" />
                                    </div>
                                </div>
                                <%--<div class="form-group row">
        <div class="col-sm-12 stdnt-btn">
            <a id="A1" href="../ManageStudent/NewUser.aspx" target="_blank" class="usermanual btn btn-primary btn-block hvr-sweep-to-right">
                SIGN UP (New User) <i class="fa fa-plus" aria-hidden="true" style="float: right;
                    margin: 0px;"></i></a>
                                ...
                                <center>
                                    <a class="forgot" href="ForgotPassword_Deg.aspx" style="font-weight: bold;">Forgot Password?</a></center>
                                <%--   <div class="row">
    <div class="col-sm-12">
     <ul class="usr">
