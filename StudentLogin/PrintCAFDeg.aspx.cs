...
public partial class StudentLogin_PrintCAFDeg : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Session["StudID"] != null)
            {
                ...
                fillOption(Session["StudID"].ToString());
            }
            else
            {
    ...
    protected void fillOption(string strId)
    {
        ...
        try
        {
            ...
            if (list.Count > 0)
            {
                if (list.Count == 1 && list[0].UserId==0)
                {
                    list[0].UserId = 1;
                    list[0].vch_CollegeName = "";
                    list[0].Stream = "";
                    list[0].int_streamtype = "";    
                    list[0].compulsory = "";
                }
