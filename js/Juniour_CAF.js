...
function loadHostelFees() {debugger
    var xmlColls = null;
    $.ajax({
        type: 'POST',
...
function ValidateForm() {
    ...
    if (!blankFieldValidation('txtadhar', "Aadhaar No")) {
        return false;
    }
    ...
    if (!RepeatedNumbers('txtCPC', 1)) {
        alert('Please write valid PIN Code');
    ...
    if (((document.getElementById('ddlBoard').value == 46) && ($('#ddlYOP').val() >= 2010)) || ((document.getElementById('ddlBoard').value == 103) && ($('#ddlYOP').val() >= 2012))) {
        ...
        if (Eng >= Max) {
            alert('English Mark cannot be greater than or equal to total full mark');
            document.getElementById('txtEnglish').focus();
            return false;
        }
        ...
        if (Math >= Max) {
            alert('Mathematics Mark cannot be greater than or equal to total full mark');
            document.getElementById('txtMath').focus();
            return false;
        }
        ...
        if (Sci >= Max) {
            alert('Science Mark cannot be greater than or equal to total full mark');
            document.getElementById('txtScience').focus();
            return false;
        }
        ...
        if (SoSci >= Max) {
            alert('Social Science Mark cannot be greater than or equal to total full mark');
            document.getElementById('txtSocSci').focus();
            return false;
        }
        if (Tot == 0) {
        ...
        if (Tot > Max) {
            alert('Total Marks Obtained cannot be greater than total full mark');
            document.getElementById('txtTotMark').focus();
            return false;
        }
        if (Max == 0) {
            alert('Total full mark cannot be 0(zero)');
    ...
    if (!DropDownValidation('ddlFOcu', "Father's Occupation"))
        return false;

    if (!DropDownValidation('ddlMOcu', "Mother's Occupation"))
        return false;

    if (!DropDownValidation('ddlAIncome', 'Annual Income of the Parents'))
        return false;

    if ($('#ddlAIncome').val() == "0" || $('#ddlAIncome').val() != "4") {
...
function OpenUpload() {
    ...
    window.open('UploadPopUpJr.aspx', 'CollegeCopy', 'left=400,top=300,width=400,height=350,menubar=0,resizable=0,scrollbars=0,addressbar=0');
}
    ...
    if (ddl != "") {
        if (ddl == 'ENGLISH') {
            ...
            if (parseInt(passMTop) < passM) {
                alert('Total Marks Obtained in Compartmental Exam can not be greater than Total Full Mark');
                return false;
            }
            else {
                return true;
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (lstdtl.length > 0) {
                    ...
                    //added by Ritika Lath on 5th April 2019
...
function MarkVerify() {
    ...
    if (document.getElementById('hdnMarkVerification').value == '1') {
        ...
        $("#lblMaxMarkCpy").html($("#txtMaxMark").val());debugger;
...
function EnglishOriyaFont() {
    ...
    if (document.getElementById('rbtnOriya').checked) {
        ...
        document.getElementById('department').innerHTML = 'Bihar School Examination Board, Government of Bihar';
        ...
        var str1 = "(OLNS)";
        var OLNS = str1.bold();
        document.getElementById('lblOLNS').innerHTML = 'Are you belong to Bihar Living in Neighbouring State ' + (OLNS) + '?'
