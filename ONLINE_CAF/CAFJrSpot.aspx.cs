...
public partial class CAFJrSpot : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                //fillGeneralInformation("24J0001427");
                //fillOption("24J0001427");
                //printStatus("24J0001427");

            }
        }
        catch (Exception ex)
        {
            Util.LogError(ex, "CafJrPrintSpot_Load");
        }
    }
    protected void printStatus(string strId)
    {
        ...
        {
            Util.LogError(ex, "CafJrPrintSpot_printStatus");
        }
    }
    ...
    protected void fillOption(string strId)
    {
        ...
        {
            Util.LogError(ex, "CafJrPrintSpot_fillOption");
        }
        finally
        {
            list.Clear();
    ...
    protected void fillGeneralInformation(string strId)
    {
        ...
        {
            Util.LogError(ex, "CAFJrPrintSpot_FillGeneralInformation");
        }
    }
