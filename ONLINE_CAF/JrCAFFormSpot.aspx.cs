...
public partial class ONLINE_CAF_JrCAFFormSpot : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
         {
            ...
            if (!(Request.QueryString["open"] != null && Request.QueryString["open"] == "2528"))
            {
            ...
            if (!IsPostBack)
            {
                ...
                //ddlCState.SelectedValue = "1";
                    ...
                    if (HttpContext.Current.Items["Board"] != null)
                    {
                        viewPreviousData();
                        AutoValidateDisable();
                        HideShowMainControls();//added by ritika lath
                    }
                    else
                    {
        ...
        {
            Util.LogError(ex, "JrCAFFormspot");
        }
    }
    ...
    protected void viewPreviousData()
    {
        ...
        try
        {
            ...
            //added to disable ews for the other category
            if (strCategory1 != "1")
            {
    ...
    protected void sendTransferData()
    {
        ...
        try
        {
          ...
          //  string[] strAry1 = null; string[] strAry11 = null;
            ...
            //=======================Uploading Photo======================
            // File Upload logic implemented by Ritika Lath on 12th Aug 2020
            string ext = "";
            ...
            if (imgUpload.HasFile == true) //if new image is updated new bytestream created
            {
                ...
                string Orgfile = txtCMobNo.Text + "_" + formattedDateTime + "_Spot" + ext;
        ...
        if (!IsException)
        {
            ...
            Server.Transfer("ConfirmCAFJrSpot.aspx", true);
        }
