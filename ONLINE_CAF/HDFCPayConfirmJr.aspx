<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HDFCPayConfirmJr.aspx.cs" Inherits="ONLINE_CAF_HDFCPayConfirmJr" %>
...
<body>
    ...
    <div id="DivCongratulation" runat="server" class="outerbox-cograts">
        <div class="header">
            <div align="center">
                <img src="../images/checked.png" alt="" runat="server" id="imgFlag" /></div>
            <span class="sus">
                    ...
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td height="25">
                                    <strong>
                                        <asp:Label ID="lblClientTrnid" runat="server"></asp:Label>
                                    </strong>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td height="25">
                                    <strong>
                                        <asp:Label ID="lblBankTrnId" runat="server"></asp:Label>
                                    </strong>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td height="25">
                                    <strong>
                                        <asp:Label ID="lblStatus" runat="server"></asp:Label>
                                         <asp:HiddenField ID="hdnTrnDate" runat="server"></asp:HiddenField>
                                         <asp:HiddenField ID="hdnmerchantparam1" runat="server"></asp:HiddenField>
                                    </strong>
                                </td>
                            </tr>
                        </table>
                    ...
                    <td class="information">
                        <div class="print-section">
                          <%--  <asp:Button ID="btnPrintCAF" CssClass="submitBtn" runat="server" Text="Print Application Copy"
                                ForeColor="White" OnClick="btnPrintCAF_Click" Visible="false" />--%>
                            <asp:Button ID="btnPrintCafJr" CssClass="submitBtn" runat="server" Text="Print Application Copy"
                                ForeColor="White" OnClick="btnPrintCafJr_Click" Visible="false" />
                            &nbsp;&nbsp;
                        </div>
