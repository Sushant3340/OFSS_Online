<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AxisPayConfirmJr.aspx.cs" Inherits="ONLINE_CAF_AxisPayConfirmJr" %>
                                ...
                                <td height="25">
                                    <strong>
                                        <asp:Label ID="lblStatus" runat="server"></asp:Label>
                                         <asp:HiddenField ID="hdnPaymentMode" runat="server"></asp:HiddenField>
                                    </strong>
                                </td>
                            </tr>
                        </table>
