<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JrCAFForm.aspx.cs" Inherits="ONLINE_CAF_JrCAFForm"
...
.std-numbers input#txtCTeleNo {
    ...
    <script type="text/javascript">
        ...
        function ShowStagingPopUp() {
            if (!confirm('This is not the official site of OFSS, Bihar. Kindly visit  website www.Ofssbihar.org. Do you still want to continue with this website')) {
                document.location.href = 'https://ofssbihar.org';
            }
        }

        //$(document).ready(function () {
        //    $('#test').click(function () {
        //        $.blockUI({ message: $('#domMessage'), css: { width: '275px' } });
        //    });
        //});
        ...
        <div class="form-wrap">
            <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
                <%--<tr class="containerbackground" id="divStaging" runat="server">
                    <td>This is not the official site of OFSS, Bihar.
                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="padding:0; border:none;border-collapse: collapse; margin:10px 0px;">
                                        <tr>
                                            <td style="width:93px; text-align: left" class="CAFheading">
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td>
                                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                                        <tr>
                                                                                            <td width="24" style="border: solid 1px #000; padding: 5px; text-align:center">
                                                                                                <strong>
                                                                                                    <label id="lblN1">
                                                                                                        1.</label>
                                                                                                </strong>
                                                                                            </td>
                                                                                            <td width="858" colspan="3" style="border: solid 1px #000; padding: 5px; border-left: 0;">
                                                                                                <strong>
                                                                                                    <label id="lbltit">
                                                                                ...
                                                                                <td colspan="2">
                                                                                    <table width="100%" class="dotBorder" border="0" cellpadding="2" cellspacing="0">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td width="320px" style="border: solid 1px #000; padding: 5px; border-left: 0; border-top: 0;">
                                                                                                <label id="lblYOP" style="color: #000">
                                                                                            ...
                                                                                            <td width="350px" style="border: solid 1px #000; padding: 5px; border-left: 0; border-top: 0;">
                                                                                                <label id="lblExamType" style="color: #000">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td width="250" style="border: solid 1px #000; padding: 5px; border-top: 0;">
                                                                                                ...
                                                                                                <asp:Label ID="lblBoardVal" runat="server" Style="display: none"></asp:Label>
                                                                                                <div id="divOtherBoard">
                                                                                                    <asp:TextBox ID="txtOtherBoard" runat="server" Width="98%" CssClass="inputitem" onkeypress="return AllowAlphabet(event,'txtOtherBoard')"></asp:TextBox>
                                                                                                </div>
                                                                                            </td>
                                                                                            <td width="146" style="border: solid 1px #000; padding: 5px; border-left: 0; border-top: 0;">
                                                                                                <%--<asp:TextBox ID="txtYOP" runat="server" Width="90" CssClass="inputitem" MaxLength="4"
                                                                                            AutoCompleteType="disabled" onblur="FutureYearAlert();ExamType();showhideCGPA();ShowGrade();clearRollNumber();return NumericValidation('txtYOP','Please enter yo2020ear of passing  between 1984 - 2016',4);" />--%>
                                                                                                <asp:DropDownList ID="ddlYOP" runat="server" Width="100%" CssClass="inputitem"
                                                                                                ...
                                                                                                <asp:Label ID="lblYopVal" runat="server" Style="display: none"></asp:Label>
                                                                                            ...
                                                                                            <td style="border: solid 1px #000; padding: 5px; border-left: 0; border-top: 0;">
                                                                                                ...
                                                                                                <asp:Label ID="lblExamtypeVal" runat="server" Style="display: none"></asp:Label>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td id="tdDOBH" runat="server" style="border: solid 1px #000; padding: 5px; border-top: 0;">
                                                                                            ...
                                                                                            <td style="border: solid 1px #000; padding: 5px; border-left: 0; border-top: 0;" colspan="2">
                                                                                                <label id="lblRoll" style="color: #000" size="3">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td id="tdDOBF" runat="server" style="border: solid 1px #000; padding: 5px; border-top: 0;">
                                                                                                <asp:DropDownList CssClass="inputitem" style="width:25% !important" ID="ddlDay" runat="server" AppendDataBoundItems="true" onchange="BoardMark();">
                                                                                                    <asp:ListItem Value="0">DAY</asp:ListItem>
                                                                                                </asp:DropDownList>
                                                                                                <asp:DropDownList CssClass="inputitem" ID="ddlMonth" style="width:25% !important" runat="server" AppendDataBoundItems="true" onchange="BoardMark();">
                                                                                                    <asp:ListItem Value="0">MONTH</asp:ListItem>
                                                                                                </asp:DropDownList>
                                                                                                <asp:DropDownList CssClass="inputitem" ID="ddlYear" style="width:25% !important" runat="server" AppendDataBoundItems="true" onchange="BoardMark();">
                                                                                            ...
                                                                                            <td id="tdRollCdF" runat="server" style="border: solid 1px #000; padding: 5px; border-left: 0; border-top: 0;">
                                                                                                ...
                                                                                                <asp:Label ID="lblRollCodeVal" runat="server" Style="display: none"></asp:Label>
                                                                                            </td>
                                                                                            <td style="border: solid 1px #000; padding: 5px; border-left: 0; border-top: 0;" colspan="2">
                                                                                                <asp:TextBox ID="txtBoardRoll" runat="server" Width="98%" CssClass="inputitem" MaxLength="15" onKeyUp="CheckRoll('txtBoardRoll','Space/Special characters are not allowed', 7);"
                                                                                                    AutoCompleteType="disabled"
                                                                                                    onkeypress="return CheckLengthOnly('txtBoardRoll', 7);" /><asp:Label ID="lblRollNoVal" runat="server" Style="display: none"></asp:Label>
                                                                                            </td>
                                                                                        </tr>

                                                                                        <tr>
                                                                                            <td colspan="3" id="tdRollcodeMsg" style="display: none; border: solid 1px #000; padding: 5px; border-top: 0;">
                                                                                                <div>
                                                                            ...
                                                                            <tr id="trbsebdisable" style="display: none;">
                                                                                <td style="color: #000; border: solid 1px #000; padding: 5px; border-top: 0;">अगर आप BSEB Board से पास हुए हैं और भूलवश गलत परीक्षा उत्तीर्ण की साल या  परीक्षा का प्रकार या जन्म तिथि या  रोल कोड या रोल नंबर का चुनाव हो गया हैं, और इंटर स्कूल / इंटर महाविद्यालय का चुनाव भी कर चुके हे , तो सुधार करने हेतु, सबसे पहले आपको चुने गए विकल्पों/ इंटर स्कूल / इंटर महाविद्यालय को हटाना (delete) होगा, तद्पश्चात आप अपने चुने परीक्षा उत्तीर्ण की साल, परीक्षा का प्रकार ,जन्म तिथि , रोल कोड, रोल नंबर में बदलाव कर सकते हैं|
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                                                        <tr>
                                                                                            <td style="border: solid 1px #000; padding: 10px; border-top: 0;">
                                                                                                <div style="text-align: center;">
                                                                                                    <label id="lblResultMsg" runat="server" style="color: Red; text-align: center; font-size: medium"></label>
                                                                                                </div>
                                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                    <tr>
                                                                                                        <td width="2%">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td width="2%" style="border: solid 1px #000; padding: 5px; text-align:center;">
                                                                                                            <strong>
                                                                                                                <label id="lblN2">
                                                                                                                    2.</label>
                                                                                                            </strong>
                                                                                                        </td>
                                                                                                        <td width="30%" style="border: solid 1px #000; padding: 5px; border-left: 0;">
                                                                                                            <label id="lblApplicantName" style="color: #000">
                                                                                                        ...
                                                                                                        <td width="50%" colspan="2" style="border: solid 1px #000; padding: 5px; border-left: 0;">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td style="border: solid 1px #000; padding: 5px;text-align:center; border-top: 0;">
                                                                                                            <strong>
                                                                                                                <label id="lblN3">
                                                                                                                    3.</label>
                                                                                                            </strong>
                                                                                                        ...
                                                                                                        <td style="border: solid 1px #000; padding: 5px; border-left: 0; border-top: 0;">
                                                                                                            <label id="lblFname" style="color: #000">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td style="border: solid 1px #000; padding: 5px; border-left: 0; border-top: 0;">
                                                                                                            <label id="lblMname" style="color: #000">
                                                                                            ...
                                                                                            <td width="130" align="center" valign="top" style="border: solid 1px #000; padding: 10px; border-left: 0; border-top:0;" class="" <%-- onclick="return OpenUpload();"
                                                                                                style="padding: 3px; cursor: hand;"--%>>
                                                                                                <div id='imgSpan' class="text-spn">
                                                                                                    <label id="lblphototext" style="padding-left: 60px; color:#000;">
                                                                                                ...
                                                                                                <asp:FileUpload ID="imgUpload" CssClass="form-control" runat="server" style="margin-bottom:5px;" onchange="return ShowPreview(this);" />
                                                                                                <br />
                                                                                        ...
                                                                                        <tr>
                                                                                            <td style="border: solid 0px #000; padding: 0px; border-top:0;" colspan="2">
                ...
                <tr>
                    <td bgcolor="#FFFFFF">
                        <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" class="dotBorder">
                        </table>
                    </td>
                </tr>
                <tr>
                            ...
                            <tr>
                                <td>
                                    <table width="100%" style="margin-top: 0px;" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td valign="top" style="border: solid 1px #000; padding: 5px;text-align:center;">
                                                <strong>5.</strong>
                                            </td>
                                            <td>
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td colspan="8" style="border: solid 1px #000; padding: 5px;border-left: 0;">
                                                            <strong>
                                                                <label id="lbl9" style="color: #000">
                                                                    Details of Mark/Grade Secured in 10th Board Examination / बोर्ड परीक्षा में प्राप्तांक विषयवार नीचे लिखे|
                                                                </label>
                                                            ...
                                                            <div style="color: #000; font-weight: bold" id="dv9">
                                                                Note: In the Below field you need to Enter CGPA Points, if you select CBSE & Year
                                                            between 2010 to 2017 as Year of Passing.<br />
                                                                ध्यान दें : अगर आवेदक ने परीक्षा बोर्ड - CBSE
                                                            एवं परीक्षा उत्तीर्ण करने का वर्ष 2010 से 2017 के बीच चुना है तो यहाँ आवेदक को CGPA
                                                            पॉइंट्स भरने होंगे |
                                                            </div>

                                                            <br />
                                                            <%--  <div style="color: red; font-size: small; font-weight: bold" id="dv9">
                                                             बिहार बोर्ड के अलावा  CBSE, ICSE  अन्य बोर्ड के उत्तीर्ण विद्यार्थियों को भी ऑनलाइन आवेदन देने के लिए अलग से अवसर प्रदान किया जायेगा| 
Apart from Bihar board, CBSE, ICSE and other passed students of the board will also be given a separate opportunity to apply online.--%>
                                                            ...
                                                            2020 through the student Login, after releasing the result through your examination
                                                          ...
                                                          <br />
                                                                ध्यान दें  : यदि आप विद्यालय परीक्षा बोर्ड का नाम में CBSE & ICSE का चयन करते हैं और आपने
                                                            वर्ष 2020 में उक्त परीक्षा में सम्मिलित हुए हैं एवं 10 वीं का परिणाम अभी तक आपके
                                                            परीक्षा बोर्ड द्वारा घोषित नहीं किया गया है, तो आप CAF को बिना अधिकतम अंक एवं प्राप्त
                                                            अंको के भी भर सकते हैं | परिणाम घोषित होने के पश्चात आपको 28 मई 2020 से पहले, अपने
                                                            अधिकतम अंक एवं प्राप्त अंक को स्टूडेंट लॉग इन के द्वारा अपलोड करना अनिवार्य होगा
                                                            | अगर आप CAF भरने के अन्तिम तिथि के अन्दर अपना प्राप्तांक नहीं भरेंगे , तो आपका
                                                            आवेदन चयन सूची के प्रकाशन हेतु मान्य नहीं होगा एवं आपका आवेदन अस्वीकार कर दिया जाएगा
                                                            
                                                            </div>|--%>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="2%" valign="top" style="border: solid 1px #000; padding: 5px;text-align:center; border-top: 0; border-left:0">
                                                            <strong>
                                                                <label id="lblN9a">
                                                                    a.</label>
                                                            </strong>
                                                        ...
                                                        <td width="70%" valign="top">
                                                            <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                                                id="tblBSE">
                                                                <tr>
                                                                    <td bgcolor="#f5f5f5" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                                    ...
                                                                    <td bgcolor="#f5f5f5" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0; display: none;" id="tdEng">
                                                                        <strong>English
                                                                        <br />
                                                                            &#2309;&#2306;&#2327;&#2381;&#2352;&#2375;&#2332;&#2368; </strong>
                                                                    </td>
                                                                    <td bgcolor="#f5f5f5" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0; display: none;" id="tdMath">
                                                                        <strong>Mathematics
                                                                        <br />
                                                                            &#2327;&#2339;&#2367;&#2340;</strong>
                                                                    </td>
                                                                    <td bgcolor="#f5f5f5" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0; display: none;"  id="tdScience">
                                                                        <strong>Science<br />
                                                                            &#2357;&#2367;&#2332;&#2381;&#2334;&#2366;&#2344;</strong>
                                                                    </td>
                                                                    <td bgcolor="#f5f5f5" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0; display: none;" id="tdSoScience">
                                                                        <strong>Social Science<br />
                                                                            &#2360;&#2350;&#2366;&#2332;&#2358;&#2366;&#2360;&#2381;&#2340;&#2381;&#2352;</strong>
                                                                    </td>
                                                                    <td bgcolor="#f5f5f5" id="tdGradeMark" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0; display: none;">
                                                                        <strong>
                                                                            <%--Grade--%>
                                                                            <br />
                                                                            &#2346;&#2342;&#2325;&#2381;&#2352;&#2350;</strong>
                                                                ...
                                                                <tr>
                                                                    <td bgcolor="#FFFFFF" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                                        <asp:TextBox CssClass="inputitem" ID="txtMaxMark" runat="server" MaxLength="4" AutoCompleteType="disabled"
                                                                            onKeyUp="return NumericValidation('txtMaxMark','Please write only numeric values for MARKS',4);" onChange="VerifyMaximumMarks();" />
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                                        <asp:TextBox CssClass="inputitem" ID="txtTotMark" runat="server" MaxLength="4" AutoCompleteType="disabled"
                                                                            onKeyUp="return NumericValidation('txtTotMark','Please write only numeric values for MARKS',4);" onChange="VerifyMaximumMarks();" />
                                                                    </td>
                                                                    <td bgcolor="#FFFFFF" id="tdEngMrk" style="display: none; border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                                    ...
                                                                    <td bgcolor="#FFFFFF" id="tdMathMrk" style="display: none; border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                                    ...
                                                                    <td bgcolor="#FFFFFF" id="tdScienceMrk" style="display: none;border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                                    ...
                                                                    <td bgcolor="#FFFFFF" id="tdSoScienceMrk" style="display: none;border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                                    ...
                                                                    <td bgcolor="#FFFFFF" id="tdGradeMarkddl" style="display: none;border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                                ...
                                                                <tr>
                                                                    <td colspan="7" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                                        <div style="color: #000; font-weight: bold; background-color: White;" id="Div1">
                                                                            Note: Selection of the students will be done based on the Total Full Marks of the examination and Total Marks obtained or secured in the Qualifying Board Examination.
                                                                        <br />
                                                                            ध्यान दें : छात्रों का चयन सूची में चयन बोर्ड परीक्षा  के कुल पूर्ण अंक/कुल अधिकतम अंक एवं बोर्ड परीक्षा  में कुल प्राप्तांक के आधार पर होता है |
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr style="display: none;">
                                                        <td valign="top" bgcolor="#1567A1" style="text-align: center;border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;" class="whitetxt">
                                                            <strong>
                                                                <label id="lblN9b">
                                                                    b.</label>
                                                            </strong>
                                                    ...
                                                    <tr style="display: none;">
                                                        <td colspan="3" valign="top" style="border: solid 1px #000; padding: 5px;border-top: 0;">
                                                            <div id="tblComp" style="display: none;">
                                                                <table width="100%" border="0" cellspacing="0" bgcolor="#CCCCCC" cellpadding="2">
                                                                    <tr>
                        ...
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px"
                            ...
                            <tr>
                                <td>
                                    <table width="100%" style="margin-top: 0px;" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td style="border: solid 1px #000; padding: 5px;">6<strong><label id="lblN71">.</label>
                                            </strong>
                                            </td>
                                            ...
                                            <td colspan="2">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        ...
                                                        <td width="30%" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <label id="lblschname" style="color: #000">
                                                        ...
                                                        <td style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <asp:TextBox ID="txtschname" CssClass="inputitem Uppercase" runat="server" Width="280"
                                                                onkeyup="return CheckSpeCharacterSchoolName('txtschname','Special characters are not allowed');" MaxLength="150" autocomplete="off" />
                                                        </td>
                                                        ...
                                                        <td width="30%" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <label id="lblschloc" style="color: #000">
                                                        ...
                                                        <td width="25%" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <asp:TextBox ID="txtschloc" CssClass="inputitem Uppercase" runat="server" Width="100%"
                                                                onkeydown="return ValidateAddress('txtschloc', 100);" MaxLength="100" autocomplete="off" onchange="return ValidateAddress('txtCPS',100);" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="border: solid 1px #000; padding: 5px; border-top: 0;">
                                                        ...
                                                        <td style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <label id="lblinsDist" style="color: #000">
                                                        ...
                                                        <td style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <label id="lblinsYOJ" style="color: #000">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <label id="lblYOL" style="color: #000">
                                                                Year of Leaving from School<font color="#8B0000" size="3">*</font><br />
                                                                आपने किस साल उस विद्यालय छोड़ेथे |
                                                            </label>
                                                            &nbsp;<font color="#8B0000" size="3">*</font>
                                                        ...
                                                        <td style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <label id="lblKGABC" style="color: #000">
                        ...
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px;">
                            <tr>
                                <td bgcolor="#FFFFFF">
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td style="border: solid 1px #000; padding: 5px;">7<strong><label id="lblN5">.</label>
                                            </strong>
                                            </td>
                                            <td style="border: solid 1px #000; padding: 5px;border-left:0;">
                                                <strong>
                                            ...
                                            <td>
                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td style="border: solid 1px #000; padding: 5px;border-left:0;">
                                                            <label id="lblGender" style="color: #000">
                                                        ...
                                                        <td style="border: solid 1px #000; padding: 5px;border-left:0;">
                                                            <label id="lblMt" style="color: #000">
                                                        ...
                                                        <td width="" style="border: solid 1px #000; padding: 5px;border-left:0;">
                                                            <label id="lblNat" style="color: #000">
                                                    ...
                                                    <tr>
                                                        <td style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <asp:DropDownList CssClass="inputitem" ID="ddlGender" runat="server" Width="80" onchange="OptionValidation('ddlGender');loadColleges();clearDDL();">
                                                                <asp:ListItem Value="0">--SELECT--</asp:ListItem>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            <td style="border: solid 1px #000; padding: 5px;border-left:0;">
                                                ...
                                                <div style="background: #e1e1e1;">मोबाइल नंबर एवं ईमेल आईडी दर्ज करने से पहले आवेदक ये सुनिचित करले, की उनके द्वारा दर्ज किया जा रहा मोबाइल नंबर एवं ईमेल आइड दोनों ही यूनिक (पहले से किसी दुसरे  CAF में दर्ज न हो) एवं आवेदक द्वारा ही वर्तमान में इस्तेमाल किया जा रहा हों| क्योंकि भविष्य में नामांकन सम्बंधित सारी सूचनाएँ आवेदक को उनके द्वारा दर्ज यूनिक मोबाइल नंबर एवं ईमेल ईद से दी जायगी|</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        ...
                                                        <td width="8%" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <label id="lblState" style="color: #000">
                                                        ...
                                                        <td width="6%" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <label id="lblDistrict" style="color: #000">
                                                                District <font color="#8B0000" size="3">*</font>
                                                                <br />
                                                                &#2332;&#2367;&#2354;&#2366;
                                                            </label>
                                                        ...
                                                        <td width="15%" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                        ...
                                                        <td width="17%" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <label id="lblBlock" style="color: #000">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <label id="lblHouseNo" style="color: #000">
                                                                ...
                                                                स्पेस, हाइफ़न, स्लैश और कोमा को छोड़कर विशेष वर्ण कुंजी की अनुमति नहीं है।
                                                            </label>
                                                            &nbsp;
                                                        <font color="#8B0000" size="3">*</font>
                                                        </td>
                                                        <td colspan="3" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <asp:TextBox ID="txtCPS" CssClass="inputitem Uppercase" runat="server" Width="205"
                                                                ...
                                                                onkeyup="return ValidateAddress('txtCPS',100);"
                                                                onchange="return ValidateAddress('txtCPS',100);" />
                                                        </td>
                                                        <td style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <strong>
                                                                <label id="lblN6e">
                                                        ...
                                                        <td style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <label id="lblpin" style="color: #000">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <label id="lblMobileNo" style="color: #000">
                                                        ...
                                                        <td style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <label id="lblEmail" style="color: #000">
                                                        ...
                                                        <td style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <label id="lbltelephone" style="color:#000">
                                                        ...
                                                        <td class="std-numbers" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="9" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <div style="border: 1px solid #e1e1e1; padding: 0.5rem 0.8rem; background: #fafafa; margin: 0.5rem; border-radius: 0.25rem;">

                                                                <label id="lblAadharNo" style="color: #000">
                        ...
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td width="2%" style="border: solid 1px #000; padding: 5px;">9<strong><label id="lblN7">.</label>
                                            </strong>
                                            </td>
                                            <td width="100%" style="border: solid 1px #000; padding: 5px;border-left:0;">
                                                <strong>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td style="background: #e1e1e1;border: solid 1px #000; padding: 5px; border-top: 0;">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <table width="100%" cellspacing="0" cellpadding="0" class="redio-new-btns">
                                                    <tr>
                                                        ...
                                                        <td style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <asp:RadioButton ID="rbtGeneral" runat="server" GroupName="ResCategory1"
                                                                onchange="OptionValidation('cast')" Checked="true" />
                                                            <span id="GENERAL">General
                                                            <br />
                                                                &#2360;&#2366;&#2350;&#2366;&#2344;&#2381;&#2351; &#2357;&#2352;&#2381;&#2327;</span>
                                                        </td>
                                                        <td style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <asp:RadioButton ID="rbtSC" runat="server" GroupName="ResCategory1" onchange="OptionValidation('cast');loadColleges();clearDDL();" />
                                                        ...
                                                        <td style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <label>
                                                                <asp:RadioButton ID="rbtST" runat="server" GroupName="ResCategory1" onchange="OptionValidation('cast');loadColleges();clearDDL();" />
                                                        ...
                                                        <td style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <asp:RadioButton ID="rbtnOBC" runat="server" GroupName="ResCategory1" onchange="OptionValidation('cast');loadColleges();clearDDL();" />
                                                            <span id="OBC">Backward Class(BC)
                                                            <br />
                                                                &#2309;&#2344;&#2381;&#2351; &#2346;&#2367;&#2331;&#2396;&#2366; &#2357;&#2352;&#2381;&#2327;</span>
                                                        </td>
                                                        <td style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <asp:RadioButton ID="rbtOther" runat="server" GroupName="ResCategory1" onchange="OptionValidation('cast');loadColleges();clearDDL();" />
                                                            <span id="OTHER">Extremly Backward Class (EBC)
                                                            <br />
                                                                &#2309;&#2340;&#2381;&#2351;&#2306;&#2340; &#2346;&#2367;&#2331;&#2396;&#2366; &#2357;&#2352;&#2381;&#2327;
                                                            </span>
                                                        </td>
                                                        <td style="display: none;border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <asp:RadioButton ID="rbtBCW" runat="server" GroupName="ResCategory1" onchange="OptionValidation('cast');loadColleges();clearDDL();" />
                                                ...
                                                <table width="100%" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        ...
                                                        <td colspan="5" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">EWS (Economically Weaker Section)
                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="display: none;">
                                        <tr>
                                            <td width="1%">10<strong><label id="lblN8">.</label>
                                            </strong>
                                            </td>
                                            <td width="99%">
                                                <strong>
                                                    ...
                                                    <strong style="color: #000;">&nbsp;(&#2351;&#2342;&#2367; &#2354;&#2366;&#2327;&#2370;
                                                        &#2361;&#2379; &#2340;&#2379; &#2360;&#2350;&#2381;&#2348;&#2306;&#2343;&#2367;&#2340;
                                                        &#2357;&#2367;&#2325;&#2354;&#2381;&#2346; &#2325;&#2379; &#2330;&#2369;&#2344;&#2375;
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
                                        <tr>
                                            <td style="border: solid 1px #000; padding: 5px;">
                                                ...
                                                Admission.
                                                <br />
                                                    जिस कॉलेज एवं संकाय में आप नामांकन लेना चाहते हें, उन विकल्पों का चयन यहाँ भरे
                                                | </strong>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="background: #e1e1e1;border: solid 1px #000; padding: 5px; border-top: 0;">आप ऑनलाइन आवेदन पत्र के माध्यम से बीस विकल्प विभिन्न कॉलेज में आवेदन दे सकते हैं| अपने विकल्पों का चुनाव अपनी वरीयता सूची के अनुसार करें |आवेदन में विकल्प भरते समय यह सुनिश्चित करें की जो विकल्प आप पहले भरेंगे उसी के अनुसार आपका चयन किया जाएगा | विकल्पों को भरते समय यह सुनिश्चित करें कि आपकी प्राथमिकता सूची आपके पसंद के अनुरूप है | आपके द्वारा भरी गयी कॉलेजों की प्राथमिकता सूची में ऊपर से नीचे के क्रम में आपकी मेधा (अंक) एवं आरक्षण श्रेणी के अनुसार जो सबसे पहला सफल विकल्प जिसमे आपका चुनाव होगा , उस कॉलेज की नामांकन सूची में आपका नाम आएगा |
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left" style="color: #000; border: solid 1px #000; padding: 5px; border-top: 0;font-weight: bold;" colspan="2">
                                                <label id="lblinf">
                                                    You are required to select at least <span style="color: #000">10</span> and at
                                                most <span style="color: #000">20</span> options / आप न्यूनतम 10 विकल्प एवम अधिकतम 20 विकल्प यहाँ भर सकते हैं | विकल्पो का चुनाव करते समय इंटर स्कूल या इंटर महाविद्यालयो की सूची आपके द्वारा चुने लिंग (स्त्री/पुरुष/अन्य) एवं आरक्षण कोटि (सामान्य /सामान्य कमजोर वर्ग/ पिछड़ा वर्ग /अत्यंत पिछड़ा वर्ग /अनुसूचित जाति /अनुसूचित जनजाति) के अनुसार ही दर्शाया जायेगा| अगर आपसे भूलवश गलत लिंग (स्त्री/पुरुष/अन्य) या आरक्षण कोटि (सामान्य /सामान्य कमजोर वर्ग/ पिछड़ा वर्ग /अत्यंत पिछड़ा वर्ग /अनुसूचित जाति /अनुसूचित जनजाति) का चुनाव हो गया हैं, और इंटर स्कूल / इंटर महाविद्यालय का चुनाव भी कर चुके हे , तो सुधार करने हेतु, सबसे पहले आपको चुने गए विकल्पों को हटाना (delete) होगा, तद्पश्चात आप अपने चुने परीक्षा बोर्ड, परीक्षा का वर्ष, परीक्षा का प्रकार, जन्म तिथि, रोल कोड, रोल नंबर, लिंग (स्त्री/पुरुष/अन्य) और आरक्षण कोटि (सामान्य /सामान्य कमजोर वर्ग/ पिछरा वर्ग /अत्यंत पिछरा वर्ग /अनुसूचित जाति /अनुसूचित जनजाति) में बदलाव कर सकते हैं|                                          
                                                </label>

                                                <h4 id="lblBsebdisable" style="display: none;">अगर आप BSEB Board से पास हुए हैं और भूलवश गलत परीक्षा उत्तीर्ण की साल या  परीक्षा का प्रकार या जन्म तिथि या  रोल कोड या रोल नंबर का चुनाव हो गया हैं, और इंटर स्कूल / इंटर महाविद्यालय का चुनाव भी कर चुके हे , तो सुधार करने हेतु, सबसे पहले आपको चुने गए विकल्पों/ इंटर स्कूल / इंटर महाविद्यालय को हटाना (delete) होगा, तद्पश्चात आप अपने चुने परीक्षा उत्तीर्ण की साल, परीक्षा का प्रकार ,जन्म तिथि , रोल कोड, रोल नंबर में बदलाव कर सकते हैं|
                                                </h4>

                                                <h4>प्रथम मेघा सूचि निकलने के उपरांत चुने गए विकल्पों में किसी भी तरह का बदलाव संभव नही होगा, इसलिए आवेदक अच्छी तरह से सोच समझ कर विकल्पों का चयन करे, ताकि भविष्य में विकल्पों में बदलाव की आवश्यकता न पड़े| आवेदको को ये सलाह दी जाती हें की, प्राथिमिकता वाले विकल्पों को चुनने से पहले वो OFSS Portal (www.ofssbihar.org) पर “Cut-off” मेनू के अन्दर  “Intermediate 2023 cut-off” लिंक पे क्लिक कर 2023 में OFSS दारा प्रकाशित सभी विद्यालयों एवं महाविद्यालयों के संकायों का Cut-off प्रतिशत देख ले जिससे की आपको पसंदीदा विद्यालयों एवं महाविद्यालयों को चुनने में आसानी हो|</h4>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="100%" align="left" colspan="2" style="background: #c3361d; padding:5px; color:#fff; border: 1px solid #c3361d; font-size: 13px; font-weight: bold;">
                                        ...
                                        <tr>
                                            <td align="left" colspan="2">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr style="display: none">
                                                        <td style="width: 15px;border: solid 1px #000; padding: 5px; border-top: 0;">
                                                            <strong>
                                                                <label id="lbla">
                                                                    a.</label>
                                                            </strong>
                                                        </td>
                                                        <td style="width: 150px;border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <label id="lblColType" style="color: #000">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 320px;border: solid 1px #000; padding: 5px; border-left:0; border-top: 0;">
                                                            <label id="lblDname" style="color: #000">
                                                        ...
                                                        <td colspan="4" valign="middle" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                    ...
                                                    <tr>
                                                        <td width="1%" style="height: 32px;border: solid 1px #000; padding: 5px; border-top: 0;">
                                                            <strong>
                                                                <label id="lblc">
                                                                    b.</label></strong>
                                                        </td>
                                                        <td style="width: 150px;border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <label id="lblcolname" style="color: #000">
                                                                    ...
                                                                    <tr>
                                                                        <td style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                                            <asp:DropDownList CssClass="inputitem" ID="ddlCollege" runat="server" Width="300"
                                                                                onchange="fillStream(this);">
                                                                                <asp:ListItem Value="0">--SELECT--</asp:ListItem>
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                        <td width="20" height="32" align="center" style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                                            <strong>
                                                                                <label id="lbld">
                                                                                    c.</label></strong>
                                                                        </td>
                                                                        <td style="border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                                            <label id="lblStream" style="color: #000">
                                                    ...
                                                    <tr>
                                                        <td style="height: 32px; display: none;border: solid 1px #000; padding: 5px; border-top: 0;">
                                                            <strong>
                                                                <label id="lble">
                                                                    d.</label>
                                                            </strong>
                                                        </td>
                                                        <td style="width: 150px; display: none;border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <label id="comsub" style="color: #000">
                                                                Compulsory (MIL) <font color="#8B0000" size="3">*</font> / &#2309;&#2344;&#2367;&#2357;&#2366;&#2352;&#2381;&#2351;
                                                            &#2357;&#2367;&#2359;&#2351;
                                                            </label>
                                                            &nbsp;<font color="#8B0000" size="3">*</font>
                                                        </td>
                                                        <td colspan="4" style="display: none;border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <span>
                                                            ...
                                                            <table border="0" cellspacing="0" cellpadding="2" class="noBorderTab" style="display: none;">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <label id="lblMB" style="color: #000">
                                                                            Matri Bhasha <font color="#8B0000" size="3">*</font>
                                                                        </label>
                                                                    </td>
                                                                    <td id="SlblLL">
                                                                        <label id="lblLL" style="color: #000">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 150px; display: none;border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <label id="lblESub" style="color: #000">
                                                        ...
                                                        <td colspan="4" style="display: none;border: solid 1px #000; padding: 5px;border-left:0; border-top: 0;">
                                                            <table border="0" cellspacing="0" cellpadding="2" class="noBorderTab" style="display: none;">
                                                                <tr>
                                                                    <td>
                                                                        <label id="lblFESub" style="color: #000">
                                                                    ...
                                                                    <td>
                                                                        <label id="lblSESub" style="color: #000">
                                                                    ...
                                                                    <td id="SlblTESub">
                                                                        <label id="lblTESub" style="color: #000">
                                                    ...
                                                    <tr id="4thE">
                                                        <td style="display: none;border: solid 1px #000; padding: 5px; border-top: 0;">
                                        ...
                                        <tr style="">
                                            <td height="25" align="left" colspan="2" style="background: #c3361d; border: 1px solid #c3361d; font-size: 13px; font-weight: bold; padding: 5px;border-left:0; border-top: 0;">
                                                <em style="color: #000;"><strong>
                                                    <label id="lblchoice" style="color: #fff">
                                                    ...
                                                    <asp:RadioButton ID="rbtnYes" runat="server" GroupName="G1" Text="Yes/ &#2361;&#2366;&#2305;"
                                                        Style="color: #fff" onClick="HideShow();" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input name="button6" type="button" class="optionbtnNew" id="7" title="Click to add options"
                                                                onclick="ELEsubjectvalidation(); updateRow(7); " value="7th Option/ 7 &#2357;&#2366;&#2306; &#2357;&#2367;&#2325;&#2354;&#2381;&#2346;"
                                                                style="background-image: url(../images/add.png); background-repeat: no-repeat; display: none; background-position: 8px center; background-size: 12px; min-height: 30px; width: 170px; line-height: 30px; margin-top: 0px;" />
                                                        </td>
                                                        <td>
                                                ...
                                                <table border="0" align="center" cellpadding="0" cellspacing="0" style="margin-bottom:10px;">
                                                    <tr>
                                                        <td>
                                                            ...
                                                            मैं यह सत्यापित करता/करती हूँ कि उपरोक्त भरी गयी सभी सूचनाएँ सही हैं एवं ऊपर भरी गयी सूचना के गलत पाए जाने पर मेरा आवेदन पत्र अस्वीकृत किया जा सकता है | इसके लिए मेरा कोई भी दावा मान्य नहीं होगा |
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            <asp:Button CssClass="submitBtn" ID="btnSave" runat="server" Style="height: 30px; line-height: 17px;"
                                                                Text="&#2310;&#2357;&#2375;&#2342;&#2344; &#2358;&#2369;&#2354;&#2381;&#2325; 350 &#2352;&#2370;&#2346;&#2319;  &#2332;&#2350;&#2366; &#2325;&#2352;&#2344;&#2375; &#2361;&#2375;&#2340;&#2369; &#2351;&#2361;&#2366;&#2305; &#2325;&#2381;&#2354;&#2367;&#2325; &#2325;&#2352;&#2375;&#2306; | Please click here to deposit the application fee of Rs. 350. "
    ...
    <script type="text/javascript">
        loadDistricts(); checkCOSAStatus(); checkConfirmationStatus(); ExamType(); ShowGrade(); setGrade();
        $(document).ready(function () {
