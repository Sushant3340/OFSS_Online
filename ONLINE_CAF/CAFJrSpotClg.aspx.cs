...
public partial class CAFJrSpotClg : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        {
            Util.LogError(ex, "CAFJrPrintQuota_Load");
        }
    }
    protected void printStatus(string strId)
    {
        ...
        {
            Util.LogError(ex, "CAFJrPrintQuota_PrintStatus");
        }
    }
    ...
    protected void fillOption(string strId)
    {
        ...
        {
            Util.LogError(ex, "CAFJrPrintQuota_FillOption");
        }
        finally
        {
            list.Clear();
    ...
    protected void fillGeneralInformation(string strId)
    {
        ...
        {
            Util.LogError(ex, "CAFJrPrintQuota_FillGeneralInfo");
        }
    }
    ...
    public string GetPhotoDetails()
    {
        ...
        strResult = (path + "SAMS\\ONLINE_CAF\\APPL_IMAGES\\2019");
        return strResult;
    }
