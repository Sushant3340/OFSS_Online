                                        ...
                                        <td  style="background-color:#FFFFFF" >
                                            <table style="width:100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td style="width:125px" align="center"  style="padding: 3px;">
                            ...
                            <tr>
                                <td style="background-color:#FFFFFF" >
                                    <table style="width:100%" border="0" cellspacing="0" cellpadding="2">
                                                ...
                                                <div class="tablebdercaf">
                                                    <table style="width:100%" border="0" cellpadding="2" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td style="background-color:#FFFFFF"  class="smlfont" runat="server" id="tdEng">English/SL
                                                            </td>
                                                            <td style="background-color:#FFFFFF"  class="smlfont" runat="server" id="tdMath">Mathematics
                                                            </td>
                                                            <td style="background-color:#FFFFFF"  class="smlfont" runat="server" id="tdScience">Science
                                                            </td>
                                                            <td style="background-color:#FFFFFF"  class="smlfont" runat="server" id="tdSoScience">Social Science
                                                            </td>
                                                            <td id="tdGrade" runat="server" style="background-color:#FFFFFF" class="smlfont">Grade
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td style="background-color:#FFFFFF"  runat="server" id="tdEngMrk">&nbsp;
                                                            <asp:Label runat="server" ID="lblEngMark"></asp:Label>
                                                            </td>
                                                            <td style="background-color:#FFFFFF"  runat="server" id="tdMathMrk">&nbsp;
                                                            <asp:Label runat="server" ID="lblMathMark"></asp:Label>
                                                            </td>
                                                            <td style="background-color:#FFFFFF"  runat="server" id="tdScienceMrk">&nbsp;
                                                            <asp:Label runat="server" ID="lblScienceMark"></asp:Label>
                                                            </td>
                                                            <td style="background-color:#FFFFFF"  runat="server" id="tdSoScienceMrk">&nbsp;
                                                            <asp:Label runat="server" ID="lblSSMark"></asp:Label>
                                                            </td>
                                                            <td id="tdGradelbl" runat="server" style="background-color:#FFFFFF" >&nbsp;
                                        ...
                                        <tr>
                                            <td colspan="3">&nbsp;   &nbsp;   &nbsp;   &nbsp;    &nbsp;  Note : Selection of the students will be done based on the Total Marks obtained
                                        ...
                                        <td height="30" style="width:100%;">
                                            <table style="width:100%;" border="0" cellspacing="0" cellpadding="2">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Women Backward Class (WBC) / &#2346;&#2367;&#2331;&#2396;&#2375; &#2357;&#2352;&#2381;&#2327;
                                                    &#2325;&#2368; &#2350;&#2361;&#2367;&#2354;&#2366;&#2351;&#2375;
                                                    </td>
                                                    <td height="30">
                                                        <div class="sqborder1" style="width: 35px;">
            ...
            <tr>
                <td>
                    <table style="width:100%;" border="0" cellpadding="2" class="tbborderCAF">
                        <tr>
                            <td style="background-color:#FFFFFF" >
                                <table style="width:100%;" border="0" cellspacing="0" cellpadding="2" style="display: none;">
                                    <tr>
                                        <td style="width:2%;">
                                            <strong>10.</strong>
                                        </td>
