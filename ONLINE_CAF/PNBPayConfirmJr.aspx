<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PNBPayConfirmJr.aspx.cs" Inherits="ONLINE_CAF_PNBPayConfirmJr" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="DivCongratulation" runat="server" class="outerbox-cograts">
            <div class="header">
                <div align="center">
                    <img src="../images/checked.png" alt="" runat="server" id="imgFlag" />
                </div>
                <span class="sus">
