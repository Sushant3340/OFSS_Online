<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuotaSuccess.aspx.cs" Inherits="ONLINE_CAF_QuotaSuccess" %>
...
<body>
    <form id="form1" runat="server">
        <div id="DivCongratulation" runat="server" class="outerbox-cograts">
            <div class="header" id="divSuccess" runat="server" visible="false">
                <div align="center">
            ...
            <div class="header" id="divFailure" runat="server" visible="false">
                <div align="center">
                    <img src="../images/Canceled.png" alt="" />
                </div>
                <span class="sus">
