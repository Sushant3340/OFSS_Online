<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConfirmCAFJrSpotClg.aspx.cs" Inherits="ONLINE_CAF_ConfirmCAFJrClg"
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="850" border="0" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                                     ...
                                                     <td height="30" colspan="2">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="2" class="dotBorder">
                                                            <tr>
                                                                <td>&nbsp;
                                                                <label>
                                                                    <span>Application Type ( आवेदन का प्रकार )</span>
                                                                </label>
                                                                </td>
                                                                <td width="150px" height="30">
                                                                    <div class="sqborder1">
                                                                        <asp:Label runat="server" ID="lblQuotaType"></asp:Label>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                ...
                                                <tr style="display: none;">
                                                    <td height="30" align="center" bgcolor="#1567A1" class="whitetxt" style="display: none;">
                                                        <strong>
                                                            <label id="lblN7c">
                                                                c.
                                                            </label>
            ...
            <tr>
                <td align="center" style="height: 19px;padding-top:10px;">
