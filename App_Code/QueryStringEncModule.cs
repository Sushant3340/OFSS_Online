...
/// </summary>
public class QueryStringEncModule : IHttpModule
{
    ...
    void context_BeginRequest(object sender, EventArgs e)
    {
        ...
        if (context.Request.Url.OriginalString.Contains("aspx") && context.Request.RawUrl.Contains("?"))
        {
            ...
            //change done by Ritika Lath on 06-04-2020 to bypass sabpaisa return url as encryption is giving error
            else if (context.Request.HttpMethod == "GET" && !string.Equals(path, "paymentconfirmjr.aspx", StringComparison.OrdinalIgnoreCase))
            {
