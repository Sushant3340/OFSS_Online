<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CAF.aspx.cs" Inherits="ONLINE_CAF_Degree_CAF" %>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td width="93" align="center">
                            <img src="../images/BiharLogo.png" width="80" height="93" />
                        </td>
                        <td valign="top">
                                                                            ...
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        Exam Type
                                                                                        <br />
                                                                                        आपने कौन सी परीक्षा उत्तीर्ण की है
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>
                                            ...
                                            <div class="tablebdercaf">
                                                <table width="100%" border="0" cellpadding="2" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <td bgcolor="#FFFFFF" class="style3" id="tdComp12" runat="server">
                                                            Compulsory(1+2)
                                                        </td>
                                                        <td bgcolor="#FFFFFF" class="style3" id="tdComp3" runat="server">
                                                            ...
                                                            <div id="divOther" runat="server">
                                                                <strong>
                                                                    <asp:Label ID="Label2" runat="server" Text="English / Hindi"></asp:Label>
                                                                </strong>
                                                            </div>
                                                        </td>
                                                        <td bgcolor="#FFFFFF" class="style3" id="tdChemH" runat="server">
                                                            Chemistry
                                                        </td>
                                                        <td bgcolor="#FFFFFF" class="style3" id="tdMathH" runat="server">
                                                            Mathematics
                                                        </td>
                                                        <td bgcolor="#FFFFFF" class="style3" id="tdChempcb" runat="server">
                                                            Biology
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td bgcolor="#FFFFFF" id="tdComp12Mrk" runat="server">
                                                        ...
                                                        <td bgcolor="#FFFFFF" id="tdChemB" runat="server">
                                                            &nbsp;<asp:Label runat="server" ID="lblScienceMark"></asp:Label>
                                                        </td>
                                                        <td bgcolor="#FFFFFF" id="tdMathB" runat="server">
                                                            &nbsp;<asp:Label runat="server" ID="lblMathematics"></asp:Label>
                                                        </td>
                                                        <td bgcolor="#FFFFFF" id="tdChemBio" runat="server">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <strong>Have you passed Intermediate Exam Compartmentally?<br />
                                                क्या अपने इंटरमीडिएट की परीक्षा समुन्नत परीक्षा में उतीर्ण की हैं?</strong>
                                        </td>
                                        <td width="7%">
                                            <div class="sqborder1">
                    ...
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td colspan="5">
                                        <strong>9. &nbsp;&nbsp;&nbsp;Reservation Details </strong>
                                    </td>
                                </tr>
                                <tr>
                                                    ...
                                                    <div class="tablebdercaf">
                                                        <table width="100%" border="0" cellpadding="1" cellspacing="0" style="display: none">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td bgcolor="#FFFFFF" width="20px" style="display: none">
                                                                    <strong>
                    ...
                    <tr>
                        <td height="22">
                            <strong>
                                ...
                                &nbsp;&nbsp;&nbsp;Option(s)/Choice(s) Details</strong>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="tablebdercaf" >
                                <asp:GridView ID="grdOptions" runat="server" AllowPaging="false" PageSize="6" EmptyDataText="NA"
                                    Width="100%" AutoGenerateColumns="false" CellPadding="2" CellSpacing="0" BackColor="#CCCCCC"
                                    OnRowDataBound="grdOptions_RowDataBound">
                                    <Columns>
                                        <asp:BoundField DataField="int_Option_No" HeaderText="Option" />
                                        <asp:BoundField DataField="vch_CollegeName" HeaderText="College " NullDisplayText="NA" />
                                        <asp:BoundField DataField="vch_StreamName" HeaderText="Stream" NullDisplayText="NA" />
                                        <asp:BoundField DataField="int_streamtype" HeaderText="Preference" NullDisplayText="NA" />
                                        <asp:BoundField DataField="fElective" HeaderText="Subject(Honours/Pass)" NullDisplayText="NA" />
                                        <%--  <asp:BoundField DataField="int_OptionForHostel" HeaderText="Hostel Option" NullDisplayText="NA" />--%>
                                    </Columns>
                                    <HeaderStyle BackColor="#999999" ForeColor="#FFFFFF" />
                                    <RowStyle BackColor="#ffffff" />
                                </asp:GridView>
      ...
      <tr>
         <td>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
             <td align="center" colspan="2"><strong> (THE BELOW INFORMATION WILL BE FILLED AT THE TIME OF ADMISSION IN <br /> RESPECTIVE COLLEGE / यह सूचना चयनित कॉलेज में नामांकन लेते समय भरनी है) </strong></td>
            ...
            <tr>
             <td width="200px">AADHAAR CARD Number of Student</td>
            ...
            <tr>
             ...
             <tr>
              <td colspan="2"><strong> Details of the Subjects for Admission</strong></td>
             </tr>
              <tr>
               <td height="10px" colspan="2"></td>
             </tr>
            <tr>
             ...
             <div class="tablebdercaf">
              <table  width="100%" border="0" cellspacing="0" cellpadding="0">
               <tr>
                <td height="30px" align="center" style="background:#efefef;">Sl. No</td>
                 <td align="center" style="background:#efefef;">Name of the Subject</td>
               </tr>

               <tr>
                <td height="30px">Subsidiary Subject 1</td>
                <td></td>
               </tr>
                <tr>
                <td height="30px">Subsidiary Subject 2</td>
                <td></td>
               </tr>
                <tr>
                <td height="30px">Compulsory Subject</td>
                <td></td>
               </tr>
               </table>
               </div>
             ...
             <tr>
              <td height="30px" width="50%"><strong> Details of the Subjects for Admission</strong></td>
              <td align="right"><strong> Signature of Verifying Officer </strong></td>
             </tr>
             ...
             <tr>
               <td height="30px" colspan="2"><strong>Date of Verification :______/_________/_________ </strong></td>
             </tr>
