...
public partial class ONLINE_CAF_Degree_CAFSpotClg : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        if (!IsPostBack)
        {
           ...
           //string strAppId = Session["Uid"].ToString(); // Request.QueryString["Appid"];"17D294347";
            ...
            //fillGeneralInformation("18D294461");
            //fillOption("18D294461");
            //FillDocument();
            //printStatus("18D294461");
    ...
    protected void fillGeneralInformation(string strId)
    {
        ...
        try
        {
                ...
                list = ccobjcafdeg.fillPrintOption(obj);
        ...
        if (list.Count > 0)
        {
            ...
            else
            {
             ...
             //   lblBoardApp.Text = list[0].vch_CouncilName.ToString().ToUpper();
            }
            ...
            //if (Convert.ToInt32(list[0].BoardId) == 35)
            {
                ...
                tdChempcb.Visible = false;

                tdComp12Mrk.Visible = false;
                tdEngMrk.Visible = false;
                tdChemB.Visible = false;
                tdMathB.Visible = false;
                tdChemBio.Visible = false;
            }
            else
            {
                ...
                tdChempcb.Visible = true;

                tdComp12Mrk.Visible = false;
                tdEngMrk.Visible = true;
                tdChemB.Visible = true;
                tdMathB.Visible = true;
                tdChemBio.Visible = true;
            }
        ...
        lblUid.Text = strUid;
        Label3.Text = strUid;
        //lblUidApp.Text = strUid;
       // RefId.Text = strUid;
        imgId.ImageUrl = "../CODE39/BarCode39.aspx?ID=" + strUid.ToString().Trim();
        Image1.ImageUrl = "../CODE39/BarCode39.aspx?ID=" + strUid.ToString().Trim();
        //imgIdApp.ImageUrl = "../CODE39/BarCode39.aspx?ID=" + strUid.ToString().Trim();
       // ImageCode.ImageUrl = "../CODE39/BarCode39.aspx?ID=" + strUid.ToString().Trim();
      //  RefId.Text = strUid;
        ...
        //if (lblPI.Text.Trim() == "OTHERS")
        //{
        //    trBI.Style.Add("display", "none");
        //    lblN11.InnerText = "11";
        //    lblN12.InnerText = "12";
        //}
        //else
        //{
        //    trBI.Style.Clear();
        //    lblN11a.InnerText = "11";
        //    lblN11.InnerText = "12";
        //    lblN12.InnerText = "13";
        //    if (list[0].int_Accno == null)
        //    {
        //        lblAcNo.Text = "";
        //    }
        //    else if (list[0].int_Accno.ToString() == "0")
        //    {
        //        lblAcNo.Text = "";
        //    }
        //    else
        //    {
        //        lblAcNo.Text = list[0].int_Accno.ToString();
        //    }

        //    if (list[0].vch_IFSCno == null)
        //    {
        //        lblIFSC.Text = "";
        //    }
        //    else if (list[0].vch_IFSCno.ToString() == "0")
        //    {
        //        lblIFSC.Text = "";
        //    }
        //    else
        //    {
        //        lblIFSC.Text = list[0].vch_IFSCno.ToString();
        //    }

        //    if (list[0].vch_MICRcode == null)
        //    {
        //        lblMICR.Text = "";
        //    }
        //    else if (list[0].vch_MICRcode.ToString() == "0")
        //    {
        //        lblMICR.Text = "";
        //    }
        //    else
        //    {
        //        lblMICR.Text = list[0].vch_MICRcode.ToString();
        //    }

        //    if (list[0].vch_BankName == null)
        //    {
        //        lblBName.Text = "";
        //    }
        //    else if (list[0].vch_BankName.ToString() == "0")
        //    {
        //        lblBName.Text = "";
        //    }
        //    else
        //    {
        //        lblBName.Text = list[0].vch_BankName.ToString();
        //    }

        //    if (list[0].vch_BrName == null)
        //    {
        //        lblBrName.Text = "";
        //    }
        //    else if (list[0].vch_BrName.ToString() == "0")
        //    {
        //        lblBrName.Text = "";
        //    }
        //    else
        //    {
        //        lblBrName.Text = list[0].vch_BrName.ToString();
        //    }
        ...
        if (strUid != "")
        {
            if (File.Exists((GetPhotoDetails() + "\\" + intBlockID + "\\" + strUid + ".jpg")))
            {
               // imgPhoto.ImageUrl = ViewPhotoDetails() + "/" + intBlockID + "/" + strUid + ".jpg";
                ...
                imgPhoto.ImageUrl = "~/DownloadImage.ashx?clsid=2&id=" + "/" + intBlockID + "/" + strUid + ".jpg";
            }
            else
            {
    ...
    protected void getCompartmentalDetails(string intAppId)
    {
        ...
        //grdCompartmentApp.DataSource = list;
        //grdCompartmentApp.DataBind();
    }
    protected void fillOption(string strId)
    {
        ...
        try
        {
            ...
            if (list.Count > 0)
            {
                ...
                grdOptions.DataBind();
                //grdOptionsApp.DataSource = list;
                //grdOptionsApp.DataBind();
            }
            ...
            //{
            //   // lblAmount.Text = "200.00";
            //    //lblAmountApp.Text = "200.00";
            //}
            //else if ((lblobc.Text.Trim() == "Yes") || (lblOther.Text.Trim() == "Yes") || (lblGeneral.Text.Trim() == "Yes"))
            //{
            //   // lblAmount.Text = "300.00";
            //    //lblAmountApp.Text = "300.00";
            //}
    ...
    protected void FillDocument()
    {
        ...
        DocDatasource.ReadXml(pth + "SAMS\\MasterXML/M_DOCAttachedDEG.xml");
        DataView dvSource = default(DataView);
        dvSource = DocDatasource.Tables[0].DefaultView;

        dvSource = DocDatasource.Tables[0].DefaultView;
        string FilterData = "int_DocumentID in (1,2,3";
        ...
        //if ((lblOSA.Text == "Yes") || (lblOlns.Text == "Yes"))
        //{
        //    FilterData = (FilterData + ",9");
        //}
        ...
        if ((lblNssU.Text == "Yes") || (lblNssS.Text == "Yes") || (lblNssN.Text == "Yes") || (lblNssIN.Text == "Yes"))
        {
            FilterData = (FilterData + ",14");
        }

        //if (lblPI.Text != "OTHERS")
        //{
        //    FilterData = (FilterData + ",15");
        //    FilterData = (FilterData + ",16");
        //}

        FilterData = (FilterData + ")");
        dvSource.RowFilter = FilterData;
        //grdDOC.DataSource = dvSource;
        //grdDOC.DataBind();
    }
    protected void printStatus(string strId)
    {
        ...
        try
        {
                ...
                string Status = ccobjcafdeg.AddPrintStatus(obj1);
    ...
    //}
    protected void grdOptionsApp_RowDataBound(object sender, System.Web.UI.WebControls.GridViewRowEventArgs e)
    {
        if ((e.Row.RowType == DataControlRowType.DataRow))
        {
            string strElectives = e.Row.Cells[4].Text;
    ...
    {
         return QueryStringEncModule.Decrypt(strQueryString);
