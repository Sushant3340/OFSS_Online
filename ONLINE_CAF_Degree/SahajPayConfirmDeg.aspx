<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SahajPayConfirmDeg.aspx.cs" Inherits="SahajPayConfirmDeg" %>
...
<body>
    ...
    <div id="DivCongratulation" runat="server" class="outerbox-cograts" >
        <div class="header">
        <div align="center"> <img src="../images/checked.png" alt=""  runat="server" id="imgFlag" /></div>
                ...
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td>
                                    <span style="font-size: 14px;">Sahaj Transaction Id:</span>
                                </td>
                                <td height="25">
                                    <strong>
                                        <asp:Label ID="lblSajaTrnId" runat="server"></asp:Label>
                                    </strong>
                                </td>
                            </tr>
                            <tr>
