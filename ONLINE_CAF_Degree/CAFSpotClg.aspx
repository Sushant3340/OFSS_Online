<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CAFSpotClg.aspx.cs" Inherits="ONLINE_CAF_Degree_CAFSpotClg" %>
...
<body onload="showHideChem();dateTime();" style="border: 0px;">
                            ...
                            <table width="90%" border="0" align="right" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td height="22" align="center" class="style2Print">
                                       <strong><u> for Spot Admission to Degree Colleges (2018-21)</u></strong>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <td bgcolor="#FFFFFF">
                                <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                    ...
                                    <tr id="MarkVerification" runat="server">
                                        ...
                                        <td width="40px">
                                            <div class="sqborder1" width="50px" style="display: none">
                                ...
                                <tr>
                                    ...
                                    <td height="30" colspan="2">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                            <tr>
                                                <td>
                                                    Schedule Tribe (ST) / अनुसूचित जनजाति<br />
                                                </td>
                                                <td height="30">
                                                    <div class="sqborder1">
                    ...
                    <tr>
                        <td height="22">
                            <strong>
                                ...
                                जिस कॉलेज में आप Spot Admission से नामांकन लेना चाहते हैं उसकी विवरणी नीचे भरें
                                |</strong>
                        </td>
                    </tr>
                    <tr>
 ...
 <br />  <br />
    <br />  <br /> <br /><br /><br /><br />
    <table width="990" border="0" align="center" cellpadding="0" cellspacing="0" style="display:none">
        <tr>
            <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
