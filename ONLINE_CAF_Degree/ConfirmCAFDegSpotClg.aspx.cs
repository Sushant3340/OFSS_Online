...
public partial class ONLINE_CAF_Degree_ConfirmCAFClg : System.Web.UI.Page
{
    ...
    protected void sendTransferData()
    {
        ...
        Server.Transfer("CAFDegSpotClg.aspx", true);
    ...
    {
        string strURL = "CAFSpotClg.aspx?AppId1=" + AppId + "&Mob=" + lblmob.Text.Trim() + "&Email=" + lblemail.Text.Trim() + "&Nm=" + lblApplName.Text.Trim();
        return strURL;
