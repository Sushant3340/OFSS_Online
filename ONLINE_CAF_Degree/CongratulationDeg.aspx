<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CongratulationDeg.aspx.cs"
    Inherits="ONLINE_CAF_Degree_CongratulationDeg" %>
                            ...
                            <tr>
                                <td class="redinform">
                                    ...
                                    <p class="congo-text">
                                        ...
                                        payment your form will not be considered as submitted.</p>
                                    <p class="congo-text">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td width="125px" colspan="3">
                                                ...
                                                Application Fee Amount:</td>
                                            <td >
                                              <strong>  Rs.300</strong></td>
                        ...
                        <div class="redtxtind01">
                            <div>
                                <table>
                                    <tr>
                                        <td>
                                            Select your payment option / अपने भुगतान का विकल्प चुनें। -
                                        </td>
                                        <td>
