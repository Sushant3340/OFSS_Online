<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConfirmCAFDegSpot.aspx.cs" Inherits="ONLINE_CAF_Degree_ConfirmCAFSpot"
...
//                document.getElementById('tdBiologyB').style.display = "";
    ...
    <script language="javascript" type="text/javascript" src="../js/Common_Deg.js"></script>
</head>
<body onload="showHideChem();ConfirmOptions();" style="background-color: #f7f7f7;">
    ...
    <table width="850" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <table width="90%" border="0" align="right" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td height="22" align="center" class="style2">
                                            <label id="adm">
                                                for Spot Admission to Degree Colleges (2018-21)
                                            </label>
                                        </td>
                                    </tr>
                                    <tr>
        ...
        <tr>
            <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="2" class="tbborderCAF" style="display:none">
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <strong>&nbsp;
                                <label id="lbloption">
