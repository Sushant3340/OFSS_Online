...
public partial class ONLINE_CAF_CAFForm_DEG : System.Web.UI.Page
{
    ...
    protected void sendTransferData()
    {
        ...
        // ============================================================
        Server.Transfer("ConfirmCAFDeg.aspx", true);
    }
    ...
    public static dynamic fillDistWiseColg(int intDistId, int intCType, int intGender)
    {
        ...
        else
        {
            qry = from p in xdoc.Descendants("NewDataSet").Elements("Table")
                  ...
                  && Convert.ToInt32(p.Element("WomenStatus").Value) != 4
    ...
    //    //using (CAFDegBalClient objClient = new CAFDegBalClient())
    //    //{
    //    //    lst = objClient.GetStudentEligibility_Deg(objEligibility);
    //    //}
    //    //return lst;
    //}
}
