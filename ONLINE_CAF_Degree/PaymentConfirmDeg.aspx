<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PaymentConfirmDeg.aspx.cs" Inherits="ONLINE_CAF_PaymentConfirmDeg" %>
...
<body>
    ...
    <div id="DivCongratulation" runat="server" class="outerbox-cograts" >
        <div class="header">
        <div align="center"> <img src="../images/checked.png" alt=""  /></div>
            
            <span class="sus"><asp:Label ID="lblPaymentMsg" runat="server"></asp:Label>
            </span>
        </div>
