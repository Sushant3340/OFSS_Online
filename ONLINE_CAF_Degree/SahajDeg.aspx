<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SahajDeg.aspx.cs" Inherits="ONLINE_CAF_SahajDeg" %>
...
<asp:HiddenField runat="server" ID="AppType"/>
<asp:HiddenField runat="server" ID="response_url"/>
<asp:HiddenField runat="server" ID="Checksumkey"/>
    <asp:Button ID="Button1" runat="server" Style="display: none;" />
    </form>
    <div>
        Your payment is being processed through Sahaj...<br />
        This may take a few minutes.Please do not click back or reload this page.
    </div>
</body>
</html>
