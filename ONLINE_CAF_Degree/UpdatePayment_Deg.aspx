<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdatePayment_Deg.aspx.cs"
    Inherits="ONLINE_CAF_Degree_UpdatePayment_Deg" %>
        ...
        <div id="DivCongratulation" runat="server">
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtClientTId" runat="server" MaxLength="20" CssClass="form-Control"></asp:TextBox>
